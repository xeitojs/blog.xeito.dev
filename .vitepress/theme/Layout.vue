...
<template>
  <div class="antialiased dark:bg-[#1e1e20]">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 xl:max-w-5xl xl:px-0">
      <nav class="flex justify-between items-center py-10 font-bold">
        <a class="text-xl" href="/" aria-label="Xeito Blog">
          <img
            ...
            src="/logo.svg"
          />
          <span v-if="!isIndex" class="hidden md:inline dark:text-white">Xeito Blog</span>
        </a>
